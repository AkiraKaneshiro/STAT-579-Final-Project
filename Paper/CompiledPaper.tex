...
Our analysis suggests that popularity and availability of wifi do not seem to matter for people's lodging experience. However, there is a strong correlation between price range and customer satisfaction according to Figure 12a which shows the distribution of ratings by price range. High-priced hotels receive better reviews compared to budget hotels. One possible explanation is that overnight stay in a hotel is mostly attractive to high-end customers who value quality of amenities and customer service more than just price. This observation supports the commonly held belief among travelers that you get what you pay for.
